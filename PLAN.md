...
| D22 | Traced art ships as a three-animal trial, not a cast-wide swap | The open question is aesthetic, not technical. Traced animals are anatomically right but less *cute* — small heads and small eyes, where a two-year-old wants the opposite — and no amount of desk review answers that. Three converted animals beside twenty-seven drawn ones is the cheapest way to get an answer from the only reviewer who counts |
